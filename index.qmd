...
print("Summary Table: Pay Basis")
print(pay_basis_stats)
cat("The Mode for Pay Basis is:", pay_basis_mode)
```
...
#### Summary for Categorical Variable: Agency Name (Top 10)
...
# Calculate Diversity Metric: Number of Unique Agencies
unique_agencies <- length(unique(nyc_payroll_data_2025$`Agency Name`))

print("Top 10 NYC Agencies by Employee Count")
print(agency_summary)
cat("Total number of unique agencies represented:", unique_agencies)
```
