...
One is that the borough of Staten Island is not at all represented in the data, and while it is the least populated borough, it still has municipal workers.
...
Three visualizations investigating potential relationships between two (or more) variables in the data.\
Three testable hypotheses about the subject matter, informed by your EDA